...
public class UIUtils {
     ...
     * 显示进度条
     */
    public static ProgressDialog showProgressDialog(@NonNull Context context, @StringRes int message) {
     ...
     * 显示进度条
     */
    public static ProgressDialog showProgressDialog(@NonNull Context context, @NonNull String message) {
     ...
     * 是否提示框
     */
    public static AlertDialog createYNAlertDialog(Context context, String message, final Callback5 call) {
     ...
     * 是否提示框
     */
    public static AlertDialog showYNAlertDialog(Context context, String message, final Callback5 call) {
     ...
     * 信息提示框
     */
    public static AlertDialog createInfoAlertDialog(Context context, String message, String positiveButtonText,
            final Callback5 call) {
        return createAlertDialog(context, message, positiveButtonText, null, new Callback5() {
            @Override
            public void onAllow() {
                call.onAllow();
            }
     ...
     * 信息提示框
     */
    public static AlertDialog showInfoAlertDialog(Context context, String message, final Callback5 call) {
        AlertDialog alb = createInfoAlertDialog(context, message, context.getString(android.R.string.ok), call);
        alb.show();
        return alb;
    }
     ...
     * 对话框
     */
    public static AlertDialog createAlertDialog(Context context, String message, final Callback5 call) {
        return createAlertDialog(context, message, context.getString(android.R.string.ok),
                context.getString(android.R.string.no), call);
    }

    /**
     * 对话框
     */
    public static AlertDialog showAlertDialog(Context context, String message, final Callback5 call) {
     ...
     * 提示框
     */
    public static AlertDialog createAlertDialog(Context context, String message, String positiveButtonText,
            String negativeButtonText, Callback5 call) {
    ...
    //https://www.reddit.com/r/androiddev/comments/1mc29az/cant_change_status_bar_color_in_android_tried/
    public static void setStatusBarColorId(Activity activity, View rootLayout, @ColorInt int color) {
    ...
    public static void setStatusBarColor(Activity activity, View rootLayout, @ColorRes int color) {
        setStatusBarColorId(activity, rootLayout, ContextCompat.getColor(activity, color));
    }

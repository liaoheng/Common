...
public class AppUtils {
    ...
    public static boolean sendEmail(Context context, String to[], String subject, String content, String chooserTitle) {
    ...
    public static void openBrowser(Context context, String url, String unknownTitle) {
        try {
            ...
            UIUtils.showToast(context, unknownTitle);
        }
    }

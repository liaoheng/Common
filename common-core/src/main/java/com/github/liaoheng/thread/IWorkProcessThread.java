...
import com.github.liaoheng.util.ILogger;
...
public interface IWorkProcessThread {
    ...
    abstract class BaseHandler implements Handler {
        ...
        private ILogger mLogcat;
        private String mTag;

        public BaseHandler(ILogger logcat, String tag) {
            mLogcat = logcat;
            mTag = tag;
        }

        public BaseHandler(ILogger logcat, String tag, String name) {
            this(logcat, tag);
            mThreadName = name;
        }

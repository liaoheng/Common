...
public class TelephoneUtils {
    ...
    public static TeleInfo getSpreadtrumTeleInfo(Context context) {
        ...
        L.Log.d(TAG, "Spreadtrum: " + teleInfo);
        return teleInfo;
    }
}

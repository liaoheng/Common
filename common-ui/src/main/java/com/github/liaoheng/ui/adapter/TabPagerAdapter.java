package com.github.liaoheng.ui.adapter;
...
import com.github.liaoheng.adapter.base.BaseFragmentStatePagerAdapter;
import com.github.liaoheng.ui.model.PagerTab;
    ...
    public Fragment getItemFragment(PagerTab item, int position) {
        if (mTabPagerOperation != null) {
            ...
            if (object instanceof Fragment) {
                ...
                L.w(TAG, "TabPagerOperation is null");
                return new Fragment();
            }
        }
    }
